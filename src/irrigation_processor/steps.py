...
def simulation(context: BaseModel, preprocessed_path: xr.Dataset, calibrated_path: str, dask_client):
    from irrigation_processor.ops.simulator import irrigation_simulator

    return irrigation_simulator(context, preprocessed_path, calibrated_path, dask_client)
...
def postprocessing(
    ...
    return postprocessor(context, iwu_spatial_path,
                         iwu_temporal_path, dask_client)